  ...
  return (
    ...
    >
      ...
      <div className="flex items-center p-warehouse-md gap-warehouse-md">
        {/* Product Image */}
        <div className="relative w-16 h-16 md:w-20 md:h-20 bg-neutral-100 rounded-mobile overflow-hidden flex-shrink-0">
          {!imageError ? (
            <Image
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-mobile-base md:text-lg font-semibold text-neutral-900 truncate">
            {product.name}
          </h3>
          <p className="text-mobile-sm md:text-base text-neutral-600 truncate">
            SKU: {product.sku}
          </p>
          {product.barcode && (
            <p className="text-mobile-xs md:text-sm text-neutral-500 truncate">
              📊 {product.barcode}
            </p>
          )}
        </div>
        ...
        <div className="flex flex-col items-end gap-1">
          <div className={`
            px-2 py-1 md:px-3 md:py-2 rounded-mobile text-mobile-xs md:text-sm font-medium
            ${getStockLevelColor(product.currentQuantity)}
          `}>
            {product.currentQuantity}
          </div>
          <span className="text-mobile-xs md:text-sm text-neutral-500">
      ...
      {isExpanded && (
        <div className="border-t border-neutral-200 p-warehouse-md bg-neutral-50 animate-slide-down">
          <div className="grid grid-cols-2 gap-warehouse-md text-mobile-sm md:text-base">
            <div>
